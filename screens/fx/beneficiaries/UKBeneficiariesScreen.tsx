   ...
   const [showSuccessModal, setShowSuccessModal] = useState(false)
    ...
    const getAccounts = async () => {
        ...
        try{
          ...
          // Filter only GBP accounts
          const gbpAccounts = allBeneficiaries.filter((item: any) => item.currency === "GBP")

          setAllAccounts(gbpAccounts)
  ...
  return (
    <SafeAreaView className="bg-white h-full px-4">
        ...
        <View className='flex-1'>
            {allAccounts?.length > 0 && <Text className={`font-amedium text-xl my-4 text-center text-blue`}>GBP Saved Accounts</Text>}
            {
                loading ? (
                            ...
                            ListEmptyComponent={() => (
                                <View className='h-[70vh]'>
                                    <View className="w-full items-center mx-auto justify-center my-6 mt-16 max-w-60 flex-1">
                                        ...
                                        <Text className="text-sm text-center text-blue py-2 font-alight">No available beneficiaries for GBP account found.</Text>
                                    </View>
                                </View>
                            )}
                        />
...
export default UKBeneficiariesScreen