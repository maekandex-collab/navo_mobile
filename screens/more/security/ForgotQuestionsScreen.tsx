...
const ForgotQuestionsScreen = () => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      router.push({
        pathname: "/(protected)/(routes)/ChangeQuestions",
  ...
  return (
    <SafeAreaView className="bg-white h-full px-4">
      <Header title="Forgot Questions" showGoBack={true} onpress={() => router.back()}/>
...
export default ForgotQuestionsScreen